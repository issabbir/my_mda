...
{{--            </td>--}}
            <td>
                <input type="text" name="working_hours[]" id="working_hours" class="form-control working_hours" value="{{$items->working_hours}}" autocomplete="off" readonly >
            </td>
            <td>
            ...
            <td>
                <input type="text" name="item_remarks[]" id="item_remarks" class="form-control item_remarks" value="{{$items->remarks}}" readonly>
            </td>
        </tr>
    @endforeach
@else
...
{{--            </td>--}}
            <td>
                <input type="text" name="working_hours[]" id="working_hours" class="form-control working_hours" value=""  autocomplete="off" readonly>
            </td>
            <td>
            ...
            <td>
                <input type="text" name="item_remarks[]" id="item_remarks" class="form-control item_remarks"  value="" readonly>
            </td>
        </tr>
    @endforeach
@endif
