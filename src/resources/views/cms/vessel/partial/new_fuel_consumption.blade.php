        ...
        <div class="card-body">
            ...
            <div class="row">
                <div class="col-md-4 mb-1">
                    ...
                    <label class="input-required" for="consumption_from">Consumption From Date<span
                            class="required"></span></label>
{{--                    @dd($data)--}}
                    <div class="input-group date" onfocusout="$(this).datetimepicker('hide')" id="consumption_from" data-target-input="nearest">
                        <input type="text" name="consumption_from"  value="{{ old('consumption_from', isset($data->consumption_from)?App\Helpers\HelperClass::defaultDateTimeFormat($data->consumption_from,'LOCALDATE'):'')}}" class="form-control consumption_from" data-target="#consumption_from" data-toggle="datetimepicker" placeholder="Consumption From Date" autocomplete="off" />
                ...
                <div class="col-md-4 mb-1">
                    <label class="input-required" for="consumption_to">Consumption To Date<span
                            class="required"></span></label>
                    <div class="input-group date" onfocusout="$(this).datetimepicker('hide')" id="consumption_to" data-target-input="nearest">
                        <input type="text" name="consumption_to"  value="{{ old('consumption_to', isset($data->consumption_to)?App\Helpers\HelperClass::defaultDateTimeFormat($data->consumption_to,'LOCALDATE'):'') }}" class="form-control consumption_to" data-target="#consumption_to" data-toggle="datetimepicker" placeholder="Consumption To Date" autocomplete="off"  />
                ...
                <div class="col-md-4 mb-1">
                    <label class="input-required" for="consumption_ref_no">consumption ref no<span
                            class="required"></span></label>
                    <input type="text" name="consumption_ref_no" id="consumption_ref_no"
                           value="{{ old('consumption_ref_no', $data->consumption_ref_no) }}"
                           placeholder="SRN/FUEL/0012" class="form-control consumption_ref_no" required autocomplete="off"/>
...
{{--                        <th colspan="4">Fuel Type</th>--}}
                    ...
                    @include('cms.vessel.partial.items')
                    </tbody>
                    <tfoot>
                    <tr class="thead-dark">
