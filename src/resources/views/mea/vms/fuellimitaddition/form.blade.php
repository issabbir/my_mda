...
<form id="searchResultPeriodGridList" method="post"
      @if(isset($data['insertedData']->addition_fuel_limit_id))
      action="{{ route('fuel-limit-addition-update', ['id' => $data['insertedData']->addition_fuel_limit_id]) }}">
    <input name="_method" type="hidden" value="PUT">
    @else
        action="{{ route('fuel-limit-addition-store') }}">
    @endif
    {{ csrf_field() }}
    <div class="row">
        <div class="col-12">
                ...
                <div class="col-md-3">
                    ...
                    <div class="d-flex justify-content-end col">
                        <button type="submit" id="submit" class="btn btn btn-dark shadow mr-1 mb-1 btn-secondary">
                            @if(empty($data['insertedData']->addition_fuel_limit_id))
                                Save
                            @else
                                Update
                            @endif
                        ...
                        @else
                            <a href="{{route('fuel-limit-addition-index')}}">
