    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="card" id="form-card">
                <div class="card-body">
                    <h5 style="Color: #132548" class="card-title">Fuel Limit Addition Details </h5>
                    <hr>
                    @include('mea.vms.fuellimitaddition.form')
                </div>
            </div>
            ...
            <div class="card">
                <!-- Table Start -->
                <div class="card-body">
                    <h4 class="card-title">Fuel Limit Addition Details List</h4><!---->
                    <hr>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            $('#searchResultTable').DataTable({
                processing: true,
                serverSide: true,
                ajax: APP_URL+'/vms/datatable-fuel-limit-addition',
                columns: [
