        ...
        <div class="col-12">
            <div class="card">
                <div class="card-content">
                    <div class="card-body">
                        <h4 class="card-title"> {{ isset($data->id)?'Edit':'Add' }} Units</h4>
                                    ...
                                    <div class="row my-1">
                                        <div class="col-md-12" style="margin-top: 20px">
                                            <div class="d-flex justify-content-end col">
                                                ...
                                                <a type="reset" href="{{route("mwe.setting.unit-setting")}}" class="btn btn btn-outline-dark  mb-1"> Cancel</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
    ...
    <script>
        $(document).ready(function () {
            ...
            $('.datatable').DataTable({
                ...
                ajax: {
                    url: '{{ route('mwe.setting.unit-setting-datatable', isset($data->id)?$data->id:0 ) }}',
                    type: 'POST',
                    'headers': {
