        ...
        <div class="col-12">
            <div class="card">
                <div class="card-content">
                    <div class="card-body">
                        <h4 class="card-title"> {{ isset($data->id)?'Edit':'Add' }} Cargo</h4>
                                ...
                                <div class="col-md-4">
                                    <div class="row my-1">
                                        <div class="d-flex justify-content-end col">
                                            ...
                                            <a type="reset" href="{{route("cargo")}}" class="btn btn btn-outline-dark  mb-1"> Cancel</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Cargo List</h4>
                </div>
                <div class="card-content">
    ...
    <script>
        $(document).ready(function () {
            $('.datatable').DataTable({
                ...
                ajax: {
                    url:'{{ route('cargo-datatable', isset($data->id)?$data->id:0 ) }}',
                    type:'POST',
                    'headers': {
