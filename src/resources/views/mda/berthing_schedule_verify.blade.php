        ...
        <div class="col-12">
            <div class="card">
                <div class="card-content">
                    <div class="card-body">
                        <h4 class="card-title"> {{ isset($data->id)?'Edit':'Add' }} Berthing Schedule verify</h4>
                                    ...
                                    <div class="row my-1">
                                        <div class="col-md-12">
                                            ...
                                            <div class="input-group date" onfocusout="$(this).datetimepicker('hide')" id="arrival_date" data-target-input="nearest">
                                                <input type="text" readonly name="arrival_at" value="{{ old('arrival_at', $data->arival_at) ? date("Y-m-d", strtotime(old('arrival_at', $data->arival_at))) : "" }}" class="form-control arrival_at" data-target="#arrival_date" data-toggle="datetimepicker" placeholder="Arrival date"  oninput="this.value = this.value.toUpperCase()" />
...
{{--                                                </div>--}}
{{--                                                <input type="text"--}}
{{--                                                       name="pilotage_schedule_start"--}}
{{--                                                       value="{{ old('pilotage_schedule_start', $data->pilotage_schedule_start) }}"--}}
{{--                                                       class="form-control datetimepicker-input customError"--}}
{{--                                                       data-target="#startAt"--}}
{{--                                                       data-toggle="datetimepicker"--}}
{{--                                                       placeholder="Schedule start at">--}}
{{--                                            </div>--}}
{{--                                            @if($errors->has('pilotage_schedule_start'))--}}
{{--                                                <span class="help-block">{{ $errors->first('pilotage_schedule_start') }}</span>--}}
{{--                                            @endif--}}
{{--                                        </div>--}}
{{--                                    </div>--}}
{{--                                </div>--}}
...
{{--                                    <div class="row my-1">--}}
{{--                                        <div class="col-md-12">--}}
{{--                                            <label>Schedule end<span class="required"></span></label>--}}
...
{{--                                                </div>--}}
{{--                                                <input type="text"--}}
{{--                                                       name="pilotage_schedule_end"--}}
{{--                                                       value="{{ old('pilotage_schedule_end', $data->pilotage_schedule_end) }}"--}}
{{--                                                       class="form-control datetimepicker-input customError"--}}
{{--                                                       data-target="#endAt"--}}
{{--                                                       data-toggle="datetimepicker"--}}
{{--                                                       placeholder="Schedule end at">--}}
{{--                                            </div>--}}
{{--                                            @if($errors->has('pilotage_schedule_end'))--}}
{{--                                                <span class="help-block">{{ $errors->first('pilotage_schedule_end') }}</span>--}}
{{--                                            @endif--}}
{{--                                        </div>--}}
{{--                                    </div>--}}
{{--                                </div>--}}
{{--                            </div>--}}
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="row my-1">
                                        <div class="col-md-12">
                                            <label>Assign Pilote<span class="required"></span></label>
                                            <select name="pilot_id"  class="form-control select2 customError"   oninput="this.value = this.value.toUpperCase()">
                                                <option value="">Select a pilot</option>
                                                @forelse($pilotList as $list)
                                                    <option {{ ( old("pilot_id", $data->pilot_id ) == $list->id) ? "selected" : ""  }} value="{{ $list->id }}">{{ $list->name }}</option>
                                                @empty
                                ...
                                <div class="col-md-4">
                                    <div class="row my-1">
                                        <div class="col-md-12">
                                            <label class="input-required">Pilotage Time <span class="required"></span></label>
                                            <div class="input-group date" onfocusout="$(this).datetimepicker('hide')" id="pilotage_time" data-target-input="nearest">
                                                <input type="text" name="pilotage_time" value="{{ old('pilotage_time', isset($data->pilotage_time)?$data->pilotage_time:'') }}" class="form-control pilotageTime" data-target="#pilotage_time" data-toggle="datetimepicker" placeholder="Pilotage Time"  oninput="this.value = this.value.toUpperCase()" />
                                                <div class="input-group-append" data-target="#pilotage_time" data-toggle="datetimepicker">
                                                    <div class="input-group-text">
                                                        <i class="bx bx-calendar"></i>
                                                    </div>
                                ...
                                <div class="col-md-4">
                                    <div class="row my-1">
                                        <div class="col-md-12">
                                            <label class="input-required">Notification<span class="required"></span></label>
                                            <select name="notification_type"  class="form-control select2 customError"   oninput="this.value = this.value.toUpperCase()">
                                                <option value="">Select a type</option>
                                                <option {{ (old('notification_type', $data->notification_type) == 'SMS') ? 'Selected' : '' }} value="SMS">SMS</option>
                                                <option {{ (old('notification_type', $data->notification_type) == 'EMAIL') ? 'Selected' : '' }} value="EMAIL">EMAIL</option>
                                                <option {{ (old('notification_type', $data->notification_type) ?? 'BOTH') == 'BOTH' ? 'selected' : '' }} value="BOTH">BOTH</option>
                                            </select>

                                            @if($errors->has('notification_type'))
                                                <span class="help-block">{{ $errors->first('notification_type') }}</span>
                                            @endif
                                        </div>
                                    </div>
                                </div>
...
{{--                                    <div class="row my-1">--}}
{{--                                        <div class="col-md-12">--}}
{{--                                            <label>Lying On</label>--}}
{{--                                            <input type="text"--}}
{{--                                                   id="lying_on"--}}
{{--                                                   name="lying_on"--}}
{{--                                                   value="{{ old('lying_on', $data->lying_on) }}"--}}
{{--                                                   placeholder="Lying On" class="form-control"--}}
{{--                                                   min="0" />--}}
{{--                                            @if ($errors->has('lying_on'))--}}
{{--                                                <span class="help-block">{{ $errors->first('lying_on') }}</span>--}}
{{--                                            @endif--}}
...
{{--                                    <div class="row my-1">--}}
{{--                                        <div class="col-md-12">--}}
{{--                                            <label>lying From</label>--}}
{{--                                            <input type="text"--}}
{{--                                                   id="lying_from"--}}
{{--                                                   name="lying_from"--}}
{{--                                                   value="{{ old('lying_from', $data->lying_from) }}"--}}
{{--                                                   placeholder="Lying from" class="form-control"--}}
{{--                                                   min="0" />--}}
{{--                                            @if ($errors->has('lying_from'))--}}
{{--                                                <span class="help-block">{{ $errors->first('lying_from') }}</span>--}}
{{--                                            @endif--}}
{{--                                        </div>--}}
{{--                                    </div>--}}
{{--                                </div>--}}
...
{{--                                                   id="moor_to"--}}
{{--                                                   name="moor_to"--}}
{{--                                                   value="{{ old('moor_to', $data->moor_to) }}"--}}
{{--                                                   placeholder="Moor To" class="form-control"--}}
{{--                                                   min="0" />--}}
{{--                                            @if ($errors->has('moor_to'))--}}
{{--                                                <span class="help-block">{{ $errors->first('moor_to') }}</span>--}}
{{--                                            @endif--}}
{{--                                        </div>--}}
{{--                                    </div>--}}
{{--                                </div>--}}
                                    ...
                                    <div class="row my-1">
                                        <div class="col-md-12" style="margin-top: 20px">
                                            <div class="d-flex justify-content-end col">
                                                ...
                                                <a type="reset" href="{{route("verify-bs-create")}}" class="btn btn btn-outline-dark  mb-1"> Cancel</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $('.datatable').DataTable({
                ...
                ajax: {
                    url:'{{ route('verify-bs-datatable', isset($data->id)?$data->id:0 ) }}',
                    type:'POST',
                    'headers': {
