        ...
        <div class="col-12">
            <div class="card">
                <div class="card-content">
                    <div class="card-body">
                        <h4 class="card-title"> {{ isset($data->id)?'Edit':'Add' }} CPA Vessel</h4>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="row my-1">
                                        ...
                                        <div class="col-md-10">
                                            <input type="text" name="cpaVessels_name" value="{{ old('cpaVessels_name', $data->name) }}" placeholder=" Name" class="form-control"   oninput="this.value = this.value.toUpperCase()" />
                                            @if ($errors->has('cpaVessels_name'))
                                                <span class="help-block">{{ $errors->first('cpaVessels_name') }}</span>
                                            @endif
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="row my-1">
                                        <div class="col-md-3">
                                            <label class="input-required">Vessel type<span class="required"></span></label>
                                        </div>
                                        <div class="col-md-9">
                                            <select name="cpaVessels_type" class="select2">
                                                <option value="">Select a type</option>
                                                @forelse($types as $type)
                                                    <option {{ ($data->vessel_type_id == $type->id) ? "selected" : ""  }}  value="{{$type->id}}">{{$type->name}}</option>
                                                @empty
                                                    <option value="">Tug types empty</option>
                                                @endforelse
                                            </select>
                                            @if ($errors->has('cpaVessels_type'))
                                                <span class="help-block">{{ $errors->first('cpaVessels_type') }}</span>
                                            @endif
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="row my-1">
                                        <div class="d-flex justify-content-end col">
                                            ...
                                            <a type="reset" href="{{route("cpa-vessel")}}" class="btn btn btn-outline-dark  mb-1"> Cancel</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title"> CPA vessel List</h4>
                </div>
                <div class="card-content">
    ...
    <script>
        $(document).ready(function () {
            $('.datatable').DataTable({
                ...
                ajax: {
                    url:'{{ route('cpa-vessel-datatable', isset($data->id)?$data->id:0 ) }}',
                    type:'POST',
                    'headers': {
