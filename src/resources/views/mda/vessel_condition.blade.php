        ...
        <div class="col-12">
            <div class="card">
                <div class="card-content">
                    <div class="card-body">
                        <h4 class="card-title"> {{ isset($data->id)?'Edit':'Add' }} Vessel Conditions</h4>
                        <form method="POST" action="">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="row my-1">
                                        <div class="col-md-1"> <label class="input-required">Title<span class="required"></span></label></div>
                                        <div class="col-md-11">
                                            <input type="text" name="title" value="{{ old('title', $data->title) }}" placeholder=" Title" class="form-control"   oninput="this.value = this.value.toUpperCase()" />
                                            @if ($errors->has('title'))
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="row my-1">
                                        <div class="col-md-2"><label class="input-required">Value Type<span class="required"></span></label></div>
                                        <div class="col-md-10">
                                            <select class="form-control select2"  name="value_type">
                                                <option value="">Select One</option>
                                                <option {{old('value_type',$data->value_type)=="RADIO"? 'selected':''}}  value="RADIO">RADIO</option>
                                                <option {{old('value_type',$data->value_type)=="TEXT"? 'selected':''}} value="TEXT">TEXT</option>
                                            </select>
                                            @if ($errors->has('value_type'))
                                                <span class="help-block">{{ $errors->first('value_type') }}</span>
                                            @endif
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Vessel Conditions List</h4>
                </div>
                <div class="card-content">
    ...
    <script>
        $(document).ready(function () {
            $('.datatable').DataTable({
                ...
                ajax: {
                    url:'{{ route('vessel-condition-datatable', isset($data->id)?$data->id:0 ) }}',
                    type:'POST',
                    'headers': {
