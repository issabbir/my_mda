        ...
        <div class="col-12">
            <div class="card">
                <div class="card-content">
                    <div class="card-body">
                        <h4 class="card-title"> {{ isset($data->id)?'Edit':'Add' }} Pilotage Type</h4>
                        <form method="POST" action="">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="row my-1">
                                        <div class="col-md-2"> <label class="input-required">Name<span class="required"></span></label></div>
                                        <div class="col-md-10">
                                ...
                                <div class="col-md-6 mt-5">
                                    <div class="row">
                                        <div class="d-flex justify-content-end col">
                                            ...
                                            <a type="reset" href="{{route("pilotage-type")}}" class="btn btn btn-outline-dark  mb-1"> Cancel</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title"> Pilotage Type List</h4>
                </div>
                <div class="card-content">
    ...
    <script>
        $(document).ready(function () {
            $('.datatable').DataTable({
                ...
                ajax: {
                    url:'{{ route('pilotage-type-datatable', isset($data->id)?$data->id:0 ) }}',
                    type:'POST',
                    'headers': {
