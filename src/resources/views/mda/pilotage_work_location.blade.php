        ...
        <div class="col-12">
            <div class="card">
                <div class="card-content">
                    <div class="card-body">
                        <h4 class="card-title"> {{ isset($data->id)?'Edit':'Add' }} Pilotage work location</h4>
                        <form method="POST" action="">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea type="text" name="description" placeholder="Description"
                                                  oninput="this.value=this.value.toUpperCase();"
                                                  class="form-control">{{ old('name', $data->description) }}</textarea>
                                        @if ($errors->has('name'))
                            ...
                            <div class="row my-1">
                                <div class="d-flex justify-content-end col">
                                    ...
                                    <a type="reset" href="{{route("p-working-location")}}"
            ...
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title"> Pilotage work List</h4>
                </div>
                <div class="card-content">
    ...
    <script>
        $(document).ready(function () {
            $('.datatable').DataTable({
                ...
                ajax: {
                    url: '{{ route('p-working-location-datatable', isset($data->id)?$data->id:0 ) }}',
                    type: 'POST',
                    'headers': {
