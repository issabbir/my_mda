...
@section('content')
                        ...
                        <div class="card-content">
                            <div class="card-body">
                                <form enctype="multipart/form-data"
                                      @if(isset($data->n_ser_id)) action="{{route('navy-service-update',[$data->n_ser_id])}}"
                                      @else action="{{route('navy-service-store')}}" @endif method="post">
                                    @csrf
                                    @if (isset($data->n_ser_id))
                                        @method('PUT')
                                        <input type="hidden" id="n_ser_id" name="n_ser_id"
                                               value="{{isset($data->n_ser_id) ? $data->n_ser_id : ''}}">
                                    @endif

                                    <h5 class="card-title">Navy Service</h5>
                                    <hr>
                                    <div class="row">
                                        <div class="col-md-3 mt-1">
                                            <label class="required">Book No</label>
                                        ...
                                        <div class="col-md-3 mt-1">
                                            ...
                                            <div class="input-group">
                                                <input type="text" required autocomplete="off"
                                                       value="{{isset($data->ser_serial_no_2) ? $data->ser_serial_no_2 : ''}}"
                                                       class="form-control"
                                                       id="ser_serial_no_2"
                                                       name="ser_serial_no_2"
                                                       @if(isset($data->ser_serial_no_2)) readonly @endif
                                                />
                                            </div>
                                        </div>
                                        <div class="col-md-3 mt-1">
                                        ...
                                        <div class="col-md-3 mt-1">
                                            ...
                                            <select class="custom-select select2 form-control jetty_id"
                                                    name="jetty_id_to">
                                                @if(isset($data))
                                                    <option
                                            ...
                                            <div class="row my-1">
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="input-group date"
                                                         ...
                                                         data-target-input="nearest">
                                                        <input type="text" name="from_time" required autocomplete="off"
                                            ...
                                            <div class="row my-1">
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="input-group date"
                                                         ...
                                                         data-target-input="nearest">
                                                        <input type="text" name="to_time" required autocomplete="off"
                                    ...
                                    <div class="form-group mt-1">
                                        <div class="col-md-12 pr-0 d-flex justify-content-end">
                                            <div class="form-group">
                                                <button type="submit" name="save" onclick="return confirm('Are you sure?')" class="btn btn btn-dark shadow mr-1 mb-1">  {{ isset($data->n_ser_id)?'Update':'Save' }} </button>
                                                <a type="reset" href="{{route("navy-service")}}" class="btn btn btn-outline-dark  mb-1"> Cancel</a>
                                            </div>
                                        </div>
                                    </div>
    ...
    @include('mda.mservice.navy.list')
...
@section('footer-script')
    ...
    <script type="text/javascript">
        ...
        let cpaVessel = '{{route('get-navy-vessel')}}';
        ...
        function navyServiceList() {
            let url = '{{route('navy-service-datatable')}}';
            let oTable = $('#searchResultTable').DataTable({
                ...
                columns: [
                    ...
                    {data: 'ser_serial_no_2', name: 'ser_serial_no_2', searchable: true},
