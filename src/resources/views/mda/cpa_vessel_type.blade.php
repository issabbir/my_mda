        ...
        <div class="col-12">
            <div class="card">
                <div class="card-content">
                    <div class="card-body">
                        <h4 class="card-title"> {{ isset($data->id)?'Edit':'Add' }} CPA Vessel Type</h4>
                                ...
                                <div class="col-md-4">
                                    <div class="row my-1">
                                        <div class="d-flex justify-content-end col">
                                            ...
                                            <a type="reset" href="{{route("cpa-vessel-type")}}" class="btn btn btn-outline-dark  mb-1"> Cancel</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    <script>
        $(document).ready(function () {
            $('.datatable').DataTable({
                ...
                ajax: {
                    url:'{{ route('cpa-vessel-type-datatable', isset($data->id)?$data->id:0 ) }}',
                    type:'POST',
                    'headers': {
