...
<?php $__env->startSection('content'); ?>
                        ...
                        <div class="card-content">
                            <div class="card-body">
                                <form enctype="multipart/form-data"
                                      <?php if(isset($data->t_ser_id)): ?> action="<?php echo e(route('tug-service-update',[$data->t_ser_id])); ?>"
                                      <?php else: ?> action="<?php echo e(route('tug-service-store')); ?>" <?php endif; ?> method="post">
                                    <?php echo csrf_field(); ?>
                                    <?php if(isset($data->t_ser_id)): ?>
                                        <?php echo method_field('PUT'); ?>
                                        <input type="hidden" id="t_ser_id" name="t_ser_id"
                                               value="<?php echo e(isset($data->t_ser_id) ? $data->t_ser_id : ''); ?>">
                                    <?php endif; ?>
                                    ...
                                    <div class="row">
                                        <div class="col-md-3 mt-1">
                                            ...
                                            <input type="text" readonly
                                                   ...
                                                   id="ser_serial_no"
                                                   class="form-control"
                                                   value="<?php echo e(isset($data->ser_serial_no) ? $data->ser_serial_no : 'TG'.$gen_uniq_id); ?>"
                                            >
                                        </div>
                                        <div class="col-md-3 mt-1">
                                        ...
                                        <div class="col-md-3 mt-1">
                                            ...
                                            <select class="custom-select select2 form-control tug_id" required
                                                ...
                                                <?php if(isset($data)): ?>
                                                    <option
                                                        value="<?php echo e($data->tug_id); ?>"><?php echo e($data->tug_name); ?></option>
                                                <?php endif; ?>
                                            </select>
                                        </div>
                                        <div class="col-md-3">
                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="input-group date"
                                                        ...
                                                        <input type="text" name="working_date" required autocomplete="off"
                                                               value="<?php echo e(isset($data->working_date) ? $data->working_date : ''); ?>"
                                        ...
                                        <div class="col-md-3 mt-1">
                                            ...
                                            <select class="custom-select select2 form-control jetty_id" required
                                                ...
                                                <?php if(isset($data)): ?>
                                                    <option
                                                        value="<?php echo e($data->loc_from_id); ?>"><?php echo e($data->loc_from_name); ?></option>
                                                <?php endif; ?>
                                            </select>
                                        </div>
                                        <div class="col-md-3 mt-1">
                                            ...
                                            <select class="custom-select select2 form-control jetty_id" required
                                                ...
                                                <?php if(isset($data)): ?>
                                                    <option
                                                        value="<?php echo e($data->loc_to_id); ?>"><?php echo e($data->loc_to_name); ?></option>
                                                <?php endif; ?>
                                            </select>
                                        </div>
                                        <div class="col-md-3 mt-1">
                                            ...
                                            <select class=" form-control form-control-sm select2 search-param" id="work_id" name="work_id" required>
                                                ...
                                                <?php $__currentLoopData = $workTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option <?php echo e(isset($data) ? (($value->work_id == $data->work_id) ? 'selected' : '') : ''); ?>

                                                            value="<?php echo e($value->work_id); ?>"><?php echo e($value->work_title); ?></option>
                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="input-group date"
                                                        ...
                                                        <input type="text" name="from_time" required
                                                               value="<?php echo e(old('from_time', isset($data->from_time) ? date('H:i',strtotime($data->from_time)) : '')); ?>"
                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="input-group date"
                                                        ...
                                                        <input type="text" name="to_time" required
                                                               value="<?php echo e(old('to_time', isset($data->to_time) ? date('H:i',strtotime($data->to_time)) : '')); ?>"
                                        ...
                                        <div class="col-md-3 mt-1">
                                            ...
                                            <div class="input-group">
                                                <input type="text"
                                                       value="<?php echo e(isset($data->total_time) ? $data->total_time : ''); ?>"
                                                       class="form-control"
                                                       id="total_time"
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <textarea name="work_desc" placeholder="Work Description" class="form-control"
                                                          oninput="this.value = this.value.toUpperCase()"><?php echo e(isset($data->work_desc) ? $data->work_desc : ''); ?></textarea>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <textarea name="details" placeholder="Details" class="form-control"
                                                          oninput="this.value = this.value.toUpperCase()"><?php echo e(isset($data->details) ? $data->details : ''); ?></textarea>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group mt-1">
                                        <div class="col-md-12 pr-0 d-flex justify-content-end">
                                            <div class="form-group">
                                                <button type="submit" name="save" onclick="return confirm('Are you sure?')" class="btn btn btn-dark shadow mr-1 mb-1">  <?php echo e(isset($data->t_ser_id)?'Update':'Save'); ?> </button>
                                                <a type="reset" href="<?php echo e(route("tug-service")); ?>" class="btn btn btn-outline-dark  mb-1"> Cancel</a>
                                            </div>
                                        </div>
                                    </div>
    ...
    <?php echo $__env->make('mda.mservice.tug.list', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php $__env->startSection('footer-script'); ?>
    ...
    <script type="text/javascript">
        ...
        function navyServiceList() {
            let url = '<?php echo e(route('tug-service-datatable')); ?>';
...
<?php echo $__env->make('layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\cpa_mda\src\resources\views/mda/mservice/tug/index.blade.php ENDPATH**/ ?>