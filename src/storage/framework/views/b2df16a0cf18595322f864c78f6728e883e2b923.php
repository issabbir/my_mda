<footer class="footer footer-static footer-light">
	<p class="clearfix mb-0"><span class="float-left d-inline-block">2019 &copy; Chittagong Port Authority</span><span
			...
			Operation and Maintenance by<a class="text-primary font-weight-bold"
			           ...
			           target="_blank">
				<img src="<?php echo e(asset('assets/images/logo/cns-logo.png')); ?>" alt="users view avatar"/>
			</a>
		</span>
...
<?php /**PATH C:\xampp\htdocs\cpa_mda\src\resources\views/layouts/partial/footer.blade.php ENDPATH**/ ?>