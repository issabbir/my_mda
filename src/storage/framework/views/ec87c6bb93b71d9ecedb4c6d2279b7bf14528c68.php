...
<head>
	...
	<link rel="apple-touch-icon" href="<?php echo e(asset('assets/images/ico/apple-icon-120.html')); ?>">
...
<!-- BEGIN: Body-->
<body class="vertical-layout vertical-menu-modern 1-column  navbar-sticky footer-static blank-page blank-page" data-open="click" data-menu="vertical-menu-modern" data-col="1-column" style="background: url(<?php echo e(asset('/assets/images/pages/login-bg.jpg')); ?>) center center no-repeat; background-size: cover;">
<!-- BEGIN: Content-->
...
<?php /**PATH C:\xampp\htdocs\cpa_mda\src\resources\views/layouts/auth.blade.php ENDPATH**/ ?>