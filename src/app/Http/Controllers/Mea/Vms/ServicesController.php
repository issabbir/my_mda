...
class ServicesController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('mea.vms.services.index', compact('data'));
    }
    public function store(Request $request,$id=null)
    {
        ...
        try {
            ...
            $params = [
                ...
                "p_SERVICE_NAME" => $request->get("service_name"),
                "p_SERVICE_NAME_BN"    => $request->get("service_name_bn"),
                "p_ACTIVE_YN"          => $request->get("active_yn"),
                "p_DESCRIPTION"        => $request->get("remarks"),
                "p_INSERT_BY"          =>  Auth()->ID(),
                "o_status_code"        =>  &$statusCode,
                "o_status_message"     =>  &$statusMessage
            ];

            DB::executeProcedure('MEA.VM_SETUP_ENTRY_PKG.workshop_service_entry', $params);
    ...
    public function edit($id)
    {
        ...
        if($id){
            $insertedData   = $this->commonVmsManager->findInsertedData("MEA.VM_SETUP_ENTRY_PKG.get_workshop_service_list",$id);
        }
    ...
    public function update(Request $request, $id)
    {
        ...
        $flashMessageContent = $this->flashMessageManager->getMessage($params);
        return redirect()->route('services-index')->with($flashMessageContent['class'], $flashMessageContent['message']);
    }
    ...
    public function datatableList()
    {
        ...
        $querys = "select MEA.VM_SETUP_ENTRY_PKG.get_workshop_service_list('".$id."') from dual" ;
        ...
        return datatables()->of($entityList)
            ...
            ->addColumn('action', function ($query) {
                ...
                return '<a href="' . route('services-edit', $query->service_id) . '"><i class="bx bx-edit cursor-pointer"></i></a>';
            })->make(true);
